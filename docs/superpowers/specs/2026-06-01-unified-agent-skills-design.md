...
| 格式 | 适用智能体 | 文件结构 | 特点 |
|------|------------|----------|------|
| agentskills.io | Codex, Hermes | `SKILL.md` + `scripts/` | 标准化、可移植 |
| OpenClaw | OpenClaw | `.md` 文件 | 自有格式、简单 |
...
import (
    ...
    "github.com/daifei/agentwiki/pkg/polyant-sdk"
)
...
func (t *SearchTool) Execute(ctx context.Context, params map[string]interface{}) (*mcp.Result, error) {
    ...
    results, err := t.client.Search(ctx, query, category, tags)
    if err != nil {
        return nil, err
    }
